        ...
        <>
            ...
            <section className={styles.serviceHero}>
                ...
                <div className={styles.serviceHeroContent}>
                    <div className={styles.serviceIconLarge} data-aos="fade-down"><FiSmartphone size={28} /></div>
                    <h1 className={styles.serviceHeroTitle} data-aos="fade-up" data-aos-delay="100">GESTIÓN DE REDES SOCIALES</h1>
            ...
            {/* Service Detail Section - Sticky Split Layout */}
                ...
                <div className={styles.serviceContainer}>
                    <div className={styles.splitLayout}>
                        ...
                        <div className={styles.splitContent}>
                            <div className={styles.minimalItem} data-aos="fade-left" data-aos-delay="100">
                            ...
                            <div className={styles.minimalItem} data-aos="fade-left" data-aos-delay="200">
                            ...
                            <div className={styles.minimalItem} data-aos="fade-left" data-aos-delay="300">
                            ...
                            <div className={styles.minimalItem} data-aos="fade-left" data-aos-delay="400">
                            ...
                            <div className={styles.minimalItem} data-aos="fade-left" data-aos-delay="500">
